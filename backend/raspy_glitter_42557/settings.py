"""
Django settings for raspy_glitter_42557 project.
...
ROOT_URLCONF = 'raspy_glitter_42557.urls'
...
WSGI_APPLICATION = 'raspy_glitter_42557.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_glitter_42557 API",
    "DESCRIPTION": "API documentation for raspy_glitter_42557 App",
    "VERSION": "v1",
}
